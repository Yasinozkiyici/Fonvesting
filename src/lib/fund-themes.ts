...
export const FUND_THEMES: FundThemeDef[] = [
  {
    ...
    matchTokens: ["teknoloji", "technology", "dijital", "digital", "iletisim", "communication", "yarı iletken", "semiconductor"],
  },
  {
    id: "artificial_intelligence",
    label: "Yapay Zekâ",
    shortHint: "YZ, robotik ve otomasyon temaları",
    matchTokens: ["yapay zeka", "artificial intelligence", "ai", "robotik", "robotics", "automation", "otonom"],
  },
  {
    id: "green_energy",
    label: "Yeşil Enerji",
    shortHint: "Temiz enerji ve sürdürülebilir dönüşüm",
    matchTokens: ["temiz enerji", "clean energy", "yenilenebilir", "renewable", "solar", "gunes", "ruzgar", "wind", "surdurulebilir", "sustainability"],
  },
  {
    id: "blockchain",
    label: "Blockchain",
    shortHint: "Blokzincir ve dijital varlık altyapıları",
    matchTokens: ["blockchain", "blokzincir", "blok zincir", "kripto", "crypto", "bitcoin", "ethereum", "digital asset", "dijital varlik"],
  },
  {
    id: "precious_metals",
    label: "Altın / Gümüş",
  ...
  },
  {
    ...
    matchTokens: ["savunma", "defense", "guvenlik", "security", "havacilik", "aerospace", "uzay", "space"],
  },
  {
    id: "health_biotech",
