...
const DETAIL_MINIMAL_FUND_REST_FALLBACK_ENABLED = process.env.FUND_DETAIL_MINIMAL_FUND_REST_FALLBACK === "1";
...
const DETAIL_CORE_SERVING_FILE_ONLY = process.env.FUND_DETAIL_CORE_SERVING_FILE_ONLY !== "0";
