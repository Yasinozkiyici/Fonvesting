...
async function main() {
  ...
  const sectorSeeds = [
    { code: "XUMAL", name: "Mali Endeks", description: "Bankalar, GYO'lar, Sigorta ve Holdingler", color: "#3B82F6" },
    { code: "XUSIN", name: "Sınai Endeks", description: "Üretim, Enerji, Kimya ve Sanayi", color: "#10B981" },
    { code: "XUHIZ", name: "Hizmetler Endeksi", description: "Perakende, Ulaştırma, Turizm ve Telekom", color: "#06B6D4" },
    { code: "XUTEK", name: "Teknoloji Endeksi", description: "Yazılım ve Bilişim", color: "#6366F1" },
  ] as const;
  ...
  const stocksData = [
    {
      ...
      shortName: "THY",
      sectorId: sectors.find((s) => s.code === "XUHIZ")!.id,
    ...
    },
    {
      ...
      sectorId: sectors.find((s) => s.code === "XUMAL")!.id,
